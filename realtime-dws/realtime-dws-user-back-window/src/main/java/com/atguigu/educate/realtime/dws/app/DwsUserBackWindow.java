...
public class DwsUserBackWindow {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> topicLogDS=env.fromSource(FlinkKafkaUtil.getKafkaSource(Constant.TOPIC_START_TAG, "DwsUserBackWindow"), WatermarkStrategy.noWatermarks(), "KafkaSource");
